    ...
    <section className="w-full bg-gradient-to-br from-slate-50 via-white to-blue-50/20 min-h-screen py-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl sm:text-5xl font-black bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent mb-4 uppercase">
            Privacy Policy
          </h1>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            ...
            <p className="text-slate-700 font-medium leading-relaxed">
              Smart ePrinting - 17807 Lakecrest View Drive, #1205, Cypress, TX 77433<br />
              Email: <a href="mailto:support@smarteprinting.com" className="text-orange-600 hover:text-orange-700 font-bold">support@smarteprinting.com</a><br />
              Website: <a href="https://www.smarteprinting.com" target="_blank" rel="noopener noreferrer" className="text-orange-600 hover:text-orange-700 font-bold">www.smarteprinting.com</a><br />
              We are an independent online retailer and are not affiliated with any printer manufacturer.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            ...
            <p className="text-slate-700 font-medium">We collect information necessary for order processing and customer support only:</p>
          ...
          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            <h2 className="text-2xl font-black bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent uppercase tracking-tighter">3. How We Use Your Data</h2>
            <p className="text-slate-700 font-medium mb-3">We use data for legitimate business purposes only:</p>
            <ul className="space-y-2 ml-2">
              <li className="text-slate-700 font-medium flex items-start gap-2"><span className="text-green-600">✓</span> Order processing & fulfillment</li>
              <li className="text-slate-700 font-medium flex items-start gap-2"><span className="text-green-600">✓</span> Customer support & communication</li>
              <li className="text-slate-700 font-medium flex items-start gap-2"><span className="text-green-600">✓</span> Security & fraud prevention</li>
              <li className="text-slate-700 font-medium flex items-start gap-2"><span className="text-red-600">✘</span> We do NOT use data for advertising or selling</li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            ...
            <p className="text-slate-700 font-medium">We only share data with essential service providers under strict confidentiality. We do NOT sell personal information.</p>
          </div>

          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            <h2 className="text-2xl font-black bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent uppercase tracking-tighter">5. Cookies</h2>
            <p className="text-slate-700 font-medium">We only use essential & functional cookies. We do NOT use advertising or cross-site tracking cookies.</p>
          </div>

          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            <h2 className="text-2xl font-black bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent uppercase tracking-tighter">Your Rights</h2>
            <p className="text-slate-700 font-medium">You have rights to access, correct, delete, and port your data. Submit requests to <a href="mailto:support@smarteprinting.com" className="text-orange-600 hover:text-orange-700 font-bold">support@smarteprinting.com</a>.</p>
          </div>

          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            <h2 className="text-2xl font-black bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent uppercase tracking-tighter">CCPA Notice</h2>
            <p className="text-slate-700 font-medium">California residents: We do NOT sell or share your personal information.</p>
          </div>

          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            <h2 className="text-2xl font-black bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent uppercase tracking-tighter">Contact</h2>
...
export default PrivacyPolicy;
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="space-y-6">
          ...
          {/* 1. Who We Are */}
          <div className="bg-gradient-to-br from-white to-blue-50/30 rounded-3xl p-6 md:p-8 shadow-lg shadow-blue-100/30 border-2 border-slate-100 space-y-4 backdrop-blur-sm">
            <h2 className="text-2xl font-black bg-gradient-to-r from-orange-600 to-blue-600 bg-clip-text text-transparent uppercase tracking-tighter">
